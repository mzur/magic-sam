...
<control-button v-else v-cloak icon="fa-hat-wizard" title="Draw a polygon using the magic SAM tool 𝗭" :active="isMagicSamming" :loading="loadingMagicSam" v-on:click="toggleMagicSam"></control-button>
